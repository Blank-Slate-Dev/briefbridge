...
// Output: aia-act-from-db.txt in the project root.
...
const AIC_ACT_ID = 'cc93c1e4-b9fc-447e-a3a8-cabb9a7edf9c';
...
async function main() {
  ...
  writeFileSync('aia-act-from-db.txt', lines.join('\n'), 'utf8');
  console.log(`Wrote aia-act-from-db.txt — ${sections.length} sections, ${lines.length} lines`);
  await sql.end();
}
